...
$(document).ready(function () {
    ...
    <div class="modal fade" id="changeProfile" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <button id="clearImage" type="button" class="btn btn-white border border-secondary text-dark y">Clear</button>
                </div>
                <div class="btn-group">
  ...
  var topNavBarGenerated; var rightSideBarGenerated; var bigAvatarGenerated;

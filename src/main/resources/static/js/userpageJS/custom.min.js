...
$(document).ready(function () {
  ...
  <button type="button" class="btn btn-primary text-white resetInput">Reset</button>
    ...
    <div class="modal fade" id="changeProfile" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                  <button type="button" class="btn btn-secondary text-white triggerFileInput">Change</button>
                  <button type="button" class="btn btn-secondary text-white resetInput" disabled>Reset</button>
                  <button type="button" class="btn btn-secondary text-white clearModal" data-bs-dismiss="modal">Cancel</button>
                  <button type="button" class="btn btn-success text-white saveAccProfile">Save Changes</button>
  <div class="loader btn btn-danger" style="display:none;">
    <span></span>
    <span></span>
    <span></span>
  ...
  $(document).on("change", ".imageInput", function (e) {
    ...
    $(".resetInput").attr("disabled", false);

...
$(document).ready(function () {
  ...
  function fetchRightSideNotificationData() {
    ...
    getCurrentLoggedIn(function (userType) {
      ...
      $.ajax({
        url: `/${userType}/notification/0/` + totalItems,
        type: "GET",
        dataType: "json",
        beforeSend: function () {
...
$(document).ready(function () {
  ...
  $(document).ready(function () {
    ...
    var secondaryTotalItems = 5;
    var maximumSecondaryitem = 7;
    var mainPageCount = 0;
    ...
    function fetchData() {
      getCurrentLoggedIn(function (userType) {
        ...
        $.ajax({
          url: `/${userType}/notification/0/` + secondaryTotalItems,
          type: "GET",
          dataType: "json",
          beforeSend: function () {
  ...
  <div class="modal-dialog modal-fullscreen">
    ...
    // Manage Main Div Notification

    function fetchNotificationData(username) {
      ...
      $.ajax({
        url: `/${username}/notification/0/` + mainTotalItems,
        type: "GET",
        dataType: "json",
        beforeSend: function () {
